...
impl PayloadT {
  ...
  pub fn pack(&self, fbb: &mut flatbuffers::FlatBufferBuilder) -> Option<flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>> {
    match self {
      Self::NONE => None,
      Self::Request(v) => Some(v.pack(fbb).as_union_value()),
      Self::Response(v) => Some(v.pack(fbb).as_union_value()),
    }
  }
  ...
  pub fn as_request(&self) -> Option<&RequestT> {
    if let Self::Request(v) = self { Some(v.as_ref()) } else { None }
  }
  ...
  pub fn as_request_mut(&mut self) -> Option<&mut RequestT> {
    if let Self::Request(v) = self { Some(v.as_mut()) } else { None }
  }
  ...
  pub fn as_response(&self) -> Option<&ResponseT> {
    if let Self::Response(v) = self { Some(v.as_ref()) } else { None }
  }
  ...
  pub fn as_response_mut(&mut self) -> Option<&mut ResponseT> {
    if let Self::Response(v) = self { Some(v.as_mut()) } else { None }
  }
}
...
impl<'a> Request<'a> {
  ...
  pub fn request_id(&self) -> u32 {
    self._tab.get::<u32>(Request::VT_REQUEST_ID, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> RequestBuilder<'a, 'b> {
  ...
  pub fn add_request_id(&mut self, request_id: u32) {
    self.fbb_.push_slot::<u32>(Request::VT_REQUEST_ID, request_id, 0);
  }
  #[inline]
...
impl<'a> Response<'a> {
  ...
  pub fn response_id(&self) -> u32 {
    self._tab.get::<u32>(Response::VT_RESPONSE_ID, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> ResponseBuilder<'a, 'b> {
  ...
  pub fn add_response_id(&mut self, response_id: u32) {
    self.fbb_.push_slot::<u32>(Response::VT_RESPONSE_ID, response_id, 0);
  }
  #[inline]
...
impl<'a> MyTable<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args MyTableArgs<'args>) -> flatbuffers::WIPOffset<MyTable<'bldr>> {
      let mut builder = MyTableBuilder::new(_fbb);
      if let Some(x) = args.struct_single { builder.add_struct_single(x); }
      if let Some(x) = args.struct_vector { builder.add_struct_vector(x); }
      if let Some(x) = args.table_single { builder.add_table_single(x); }
      if let Some(x) = args.table_vector { builder.add_table_vector(x); }
      if let Some(x) = args.union_single { builder.add_union_single(x); }
      if let Some(x) = args.union_vector { builder.add_union_vector(x); }
      if let Some(x) = args.union_vector_type { builder.add_union_vector_type(x); }
      builder.add_union_single_type(args.union_single_type);
      builder.finish()
    }

    pub fn unpack(&self) -> MyTableT {
      let union_vector_type = self.union_vector_type().map(|x| {
        x.iter().collect()
      });
      let union_vector = union_vector_type.as_ref().zip(self.union_vector())
          .map(|x: (&Vec<Payload>, flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<flatbuffers::Table<'_>>>)| {
      ...
      let table_vector = self.table_vector().map(|x| {
        x.iter().map(|t| t.unpack()).collect()
      });
      let table_single = self.table_single().map(|x| {
        Box::new(x.unpack())
      });
      let struct_vector = self.struct_vector().map(|x| {
        x.iter().map(|t| t.unpack()).collect()
      });
      let struct_single = self.struct_single().map(|x| {
        x.unpack()
      });
      MyTableT {
        union_vector,
  ...
  pub fn union_vector_type(&self) -> Option<flatbuffers::Vector<'a, Payload>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Payload>>>(MyTable::VT_UNION_VECTOR_TYPE, None)
  }
  #[inline]
  pub fn union_vector(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>>>(MyTable::VT_UNION_VECTOR, None)
  }
  #[inline]
  pub fn union_single_type(&self) -> Payload {
    self._tab.get::<Payload>(MyTable::VT_UNION_SINGLE_TYPE, Some(Payload::NONE)).unwrap()
  }
  #[inline]
  pub fn union_single(&self) -> Option<flatbuffers::Table<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(MyTable::VT_UNION_SINGLE, None)
  }
  #[inline]
  pub fn table_vector(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Request<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Request>>>>(MyTable::VT_TABLE_VECTOR, None)
  }
  #[inline]
  pub fn table_single(&self) -> Option<Request<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Request>>(MyTable::VT_TABLE_SINGLE, None)
  }
  #[inline]
  pub fn struct_vector(&self) -> Option<&'a [MyStruct]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, MyStruct>>>(MyTable::VT_STRUCT_VECTOR, None).map(|v| v.safe_slice())
  }
  #[inline]
...
impl flatbuffers::Verifiable for MyTable<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<Payload, _>(&"union_single_type", Self::VT_UNION_SINGLE_TYPE, &"union_single", Self::VT_UNION_SINGLE, false, |key, v, pos| {
        match key {
          Payload::Request => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Request>>("Payload::Request", pos),
          Payload::Response => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Response>>("Payload::Response", pos),
          _ => Ok(()),
        }
     })?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Request>>>>(&"table_vector", Self::VT_TABLE_VECTOR, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Request>>(&"table_single", Self::VT_TABLE_SINGLE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, MyStruct>>>(&"struct_vector", Self::VT_STRUCT_VECTOR, false)?
...
pub struct MyTableArgs<'a> {
    ...
    pub union_vector: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<flatbuffers::UnionWIPOffset>>>>,
    pub union_single_type: Payload,
    pub union_single: Option<flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>>,
    pub table_vector: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Request<'a>>>>>,
...
impl<'a: 'b, 'b> MyTableBuilder<'a, 'b> {
  #[inline]
  pub fn add_union_vector_type(&mut self, union_vector_type: flatbuffers::WIPOffset<flatbuffers::Vector<'b , Payload>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MyTable::VT_UNION_VECTOR_TYPE, union_vector_type);
  }
  #[inline]
  pub fn add_union_vector(&mut self, union_vector: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<flatbuffers::UnionWIPOffset>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MyTable::VT_UNION_VECTOR, union_vector);
  }
  #[inline]
  pub fn add_union_single_type(&mut self, union_single_type: Payload) {
    self.fbb_.push_slot::<Payload>(MyTable::VT_UNION_SINGLE_TYPE, union_single_type, Payload::NONE);
  }
  #[inline]
  pub fn add_union_single(&mut self, union_single: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MyTable::VT_UNION_SINGLE, union_single);
  }
  #[inline]
  pub fn add_table_vector(&mut self, table_vector: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Request<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MyTable::VT_TABLE_VECTOR, table_vector);
  }
  #[inline]
  pub fn add_table_single(&mut self, table_single: flatbuffers::WIPOffset<Request<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Request>>(MyTable::VT_TABLE_SINGLE, table_single);
  }
  #[inline]
  pub fn add_struct_vector(&mut self, struct_vector: flatbuffers::WIPOffset<flatbuffers::Vector<'b , MyStruct>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MyTable::VT_STRUCT_VECTOR, struct_vector);
  }
  #[inline]
  pub fn add_struct_single(&mut self, struct_single: &MyStruct) {
    self.fbb_.push_slot_always::<&MyStruct>(MyTable::VT_STRUCT_SINGLE, struct_single);
  }
  #[inline]
      ...
      match self.union_single_type() {
        Payload::Request => {
          if let Some(x) = self.union_single_as_request() {
            ...
            ds.field("union_single", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        Payload::Response => {
...
impl MyTableT {
  pub fn pack<'b>(
    ...
    let table_single = self.table_single.as_ref().map(|x|{
      x.pack(_fbb)
    });
    ...
    MyTable::create(_fbb, &MyTableArgs{
      union_vector_type,
      union_vector,
      union_single_type,
      union_single,
...
pub fn size_prefixed_root_as_my_table(buf: &[u8]) -> Result<MyTable, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_my_table_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<MyTable<'a>>) {
